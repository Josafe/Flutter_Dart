import 'package:dart_vero/src/App2Pasqual/VincularSQLite/animal.dart';
...
class DB {
  ...
  static Future<void> insertar2(Animal animal) async {
    ...
    Database database = await _openDB();
    var resultado = await database.rawInsert("INSERT INTO animales (id, nombre, especie", "VALUES (${animal.id}, ${animal.nombre}, ${animal.especie}");
  }
}